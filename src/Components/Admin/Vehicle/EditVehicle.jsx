...
class EditVehicle extends Component {
  ...
  async componentDidMount() {
    await axios
      .get(
        `${APIURL}/vehicle/get-vehicle-details/${this.props.match.params.id}`
      )
      .then((res) => {
        this.setState({ vehicleDetails: res.data.VehicleDetails });
        console.log("vehicleDetails", this.state.vehicleDetails);

        this.setState({ vehicle_id: this.state.vehicleDetails.vehicle_id });
        this.setState({
          vehicle_number: this.state.vehicleDetails.vehicle_number,
        });
        this.setState({
          vehicle_name: this.state.vehicleDetails.vehicle_name,
        });
        this.setState({
          vehicle_reg_date: this.state.vehicleDetails.vehicle_reg_date,
        });
        this.setState({
          vehicle_status: this.state.vehicleDetails.vehicle_status,
        });
        this.setState({
          image: this.state.vehicleDetails.vehicle_url,
        });
  ...
  onSubmit(event) {
    ...
    formData.append("vehicle_id", this.state.vehicle_id);
    formData.append("vehicle_number", this.state.vehicle_number);
    formData.append("vehicle_name", this.state.vehicle_name);
    formData.append("vehicle_reg_date", this.state.vehicle_reg_date);
    formData.append("vehicle_status", this.state.vehicle_status);

    axios
      .put(
        `${APIURL}/vehicle/update-vehicle-details/${this.props.match.params.id}`,
        formData
      )
      .then((res) => {
        console.log("res", res);
  ...
  onDelete(event) {
    ...
    axios
      .delete(
        `${APIURL}/vehicle/delete-vehicle-details/${this.props.match.params.id}`
      )
      .then((res) => {
        console.log("res", res);
        if (res.data.code === 200) {
                            ...
                            <div className="col-lg-6">
                              <div className="p-5">
                                <div className="text-center">
                                  ...
                                  >
                                    Edit{" "}
                                    {this.state.vehicleDetails.vehicle_name}'s
                                    Details
                                  </h1>
                                </div>
                                <form
                                ...
                                >
                                  ...
                                  <div className="form-group">
                                    ...
                                    <input
                                      ...
                                      value={this.state.vehicle_reg_date}
                                      onChange={this.onChange}
                                      className="form-control form-control-user"
                                    />
                                  </div>
                                  ...
                                  <div className="form-group">
                                    ...
                                    <select
                                      ...
                                      name="vehicle_status"
                                      value={this.state.vehicle_status}
                                      onChange={this.onChange}
                                    >
