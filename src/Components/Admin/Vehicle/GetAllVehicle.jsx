...
class GetAllVehicle extends Component {
  ...
  async componentDidMount() {
    await axios.get(`${APIURL}/vehicle/get-all-vehicle`).then((response) => {
      this.setState({ vehicleList: response.data.VehicleList });
            ...
            <li className="nav-item">
              <div className="dropdown">
                <Link to="/get-all-vehicle">
                  <button className="dropbtn">
                    <i className="fa fa-bars" /> Vehicle List
                  </button>
                </Link>
              </div>
            </li>
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
              ...
              <nav className="navbar navbar-expand topbar mb-4 static-top">
                <h1 className="h3 mb-2 text-gray-800">All Vehicle List</h1>
              ...
              <div className="container-fluid">
                <p className="mb-4">All Vehicles available in here.</p>
                          ...
                          this.state.vehicleList.map((item, index) => (
                            <tbody key={index}>
                              ...
                              <td>
                                ...
                                <td>{item.vehicle_reg_date}</td>
                                <td>{item.vehicle_status}</td>
                                
                                <td>
                                  <Link
                                    to={`/get-vehicle-dtails-by-id/${item._id}`}
                                  >
                                    <button
                                      className="btnEdit"
