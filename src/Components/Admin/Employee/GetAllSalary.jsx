...
class GetAllSalary extends Component {
  constructor(props) {
    super(props);
    this.state = {
      salaryList: [],
  ...
  async componentDidMount() {
    await axios
      .get(`${APIURL}/salary/get-all-salary-details`)
      .then((response) => {
        this.setState({ salaryList: response.data. SalaryDetails });
        console.log("salaryList =>", this.state.salaryList);
      });
  }
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
              ...
              <nav className="navbar navbar-expand topbar mb-4 static-top">
                <h1 className="h3 mb-2 text-gray-800">All Salary Record List</h1>
              ...
              <div className="container-fluid">
                <p className="mb-4">All Employee Salary Available In Here.</p>
                    ...
                    <div className="table-responsive">
                      ...
                      >
                        ...
                        {this.state.salaryList.length > 0 &&
                          this.state.salaryList.map((item, index) => (
                            <tbody key={index}>
                              <tr>
                                <td>{item.S_Id}</td>
                                <td>{item.Nic}</td>
                                ...
                                <td>{item.ot_salary}</td>
                            
                                <td>
                                
                                  <Link to={`/edit-salary-details/${item._id}`}>
