...
class EditEmployeeSalary extends Component {
  ...
  async componentDidMount() {
    await axios
      .get(`${APIURL}/salary/get-all-salary-details/${this.props.match.params.id}`)
      .then((res) => {
        this.setState({ salaryDetails: res.data.SalaryDetails });
        console.log("salaryDetails", this.state.salaryDetails);

        this.setState({
          S_Id: this.state.salaryDetails.S_Id,
      });
        this.setState({
          Nic: this.state.salaryDetails.Nic,
        });
        this.setState({
          emp_name: this.state.salaryDetails.emp_name,
        });
        this.setState({
          basic_salary: this.state.salaryDetails.basic_salary,
        });
        this.setState({
          ot_salary: this.state.salaryDetails.ot_salary,
          });
  ...
  onSubmit(event) {
    ...
    axios
      .put(
        `${APIURL}/salary/update-salary-details/${this.props.match.params.id}`,
        SalaryEmpDetails
      )
      .then((res) => {
        console.log("res", res);
  ...
  onDelete(event) {
    ...
    axios
      .delete(`${APIURL}/salary/delete-salary-record/${this.props.match.params.id}`)
      .then((res) => {
        console.log("res", res);
        if (res.data.code === 200) {
          toast.success(res.data.message);
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            <div id="content">
              <nav className="navbar navbar-expand topbar mb-4 static-top">
                <h1 className="h3 mb-2 text-gray-800">Edit Salary Record</h1>
                            ...
                            <div className="col-lg-6">
                              <div className="p-5">
                                <div className="text-center">
                                  ...
                                  >
                                    Edit {this.state.salaryDetails.S_Id}'s Service
                                    Details
                                  </h1>
                                </div>
                                <form
